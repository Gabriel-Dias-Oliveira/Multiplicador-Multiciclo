...
wave create -driver freeze -pattern clock -initialvalue 0 -period 100ps -dutycycle 50 -starttime 0ps -endtime 1000ps sim:/multiplicador/clk 
...
wave modify -driver freeze -pattern constant -value 0 -starttime 325ps -endtime 1000ps Edit:/multiplicador/calcula 
...
WaveExpandAll -1
wave create -driver freeze -pattern constant -value 00000010 -range 7 0 -starttime 0ps -endtime 1000ps sim:/multiplicador/Multiplicador 
WaveExpandAll -1
